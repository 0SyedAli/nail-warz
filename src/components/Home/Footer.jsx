    ...
    <footer className="bg-white py-4" style={{ background: '#8B0000' }}>
      <div className="container">
        <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
          <p className="text-dark mb-0 small">Copyright© 2025  <Link href="/" style={{color:"#C11111"}}>Nail Warz. </Link> All Rights Reserved</p>
          ...
          <div className="d-flex gap-4 align-items-center">
            <Link href="mailto:info@nailwarz.com" className="text-dark text-decoration-none d-flex align-items-center gap-2 small">
              <Mail size={16} style={{ color: '#C11111' }} />
              <span>info@nailwarz.com</span>
            </Link>
