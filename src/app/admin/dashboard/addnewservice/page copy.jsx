...
export default function AddNewService() {
  ...
  const {
    ...
    defaultValues: { technicians: [], categories: [], images: [] },
  });
  ...
  const onSubmit = async (data) => {
    try {
      ...
      fd.append("categoryId", JSON.stringify(data.categories));
      ...
      <div className="page">
        <div className="addNewService">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {/* <label className="mt-0">Assign Categories</label>
            <select
              className="form-select input_field2 mt-1"
              {...register("category")}
            >
            ...
            <label className="mt-3">Assign Categories</label>
            ...
            <div className="d-flex flex-wrap my-2 gap-2">
              {watch("categories")?.map((id, idx) => (
                ...
                >
                  {categoryList.find((c) => c._id === id)?.categoryName || id}
                  <RxCross2 />
                </span>
              ))}
            </div>
